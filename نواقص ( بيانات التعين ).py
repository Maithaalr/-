...
if uploaded_file:
    ...
    fields = [
        ...
        "رقم الهوية", "تاريخ انتهاء الهوية", "العنوان المنطقة", "العنوان الامارة", "رقم الهاتف" , "المستوى التعليمي" , "هل المؤهل متوافق للوظيفة" , "المستوى التعليمي"
    ]
    ...
    edu_fields = ['تاريخ انتهاء الدارسة',  'درجة المؤهل' , 'المؤسسة التعليمية']
