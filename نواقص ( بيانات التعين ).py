...
if uploaded_file:
    ...
    fields = [
        ...
        "رقم الهوية", "تاريخ انتهاء الهوية", "العنوان المنطقة", "العنوان الامارة", "رقم الهاتف" , "المستوى التعليمي"
    ]
    ...
    emirati_fields = ["خلاصة القيد", "رقم البلدة", "رقم الأسرة", "الرقم الموحد"]
